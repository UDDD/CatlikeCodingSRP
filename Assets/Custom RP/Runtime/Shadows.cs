...
public class Shadows : MonoBehaviour
{
    ...
    static int
        dirShadowAtlastId = Shader.PropertyToID("_DirectionalShadowAtlas"),
    ...
    public void Cleanup()
    {
        buffer.ReleaseTemporaryRT(dirShadowAtlastId);
        ExecuteBuffer();
    }
    ...
    void RenderDirectionalShadows()
    {
        ...
        buffer.GetTemporaryRT(
            dirShadowAtlastId, atlasSize, atlasSize,
            32, FilterMode.Bilinear, RenderTextureFormat.Shadowmap
        );
